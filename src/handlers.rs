use crate::db::{add_user, get_user_from_token, get_user_list, login_user};
...
pub fn root() -> String {
    "New Apps 9 Lean Server API".into()
}

pub fn user_list() -> String {
    let conn = &APP_STATE.get().expect("AppState not initialized").db_conn;
